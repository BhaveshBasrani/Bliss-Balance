...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  media: {
    mensSneakersImage: '/collections/mens-casual-sneakers.jpg',
    mensSlidesImage: '/collections/mens-slides-sandals.jpg',
    mensSlippersImage: '/collections/mens-slippers.jpg',
    womensSandalsImage: '/collections/womens-sandals-flats.jpg',
    womensClogsImage: '/collections/womens-clogs-sneakers.jpg',
    womensSlippersImage: '/collections/womens-slippers-slides.jpg',
    lookbook1Image: '/feed/feed-bb158-1.png',
    lookbook2Image: '/feed/feed-bb158-2.png',
    lookbook3Image: '/feed/feed-bb158-3.png',
    lookbook4Image: '/feed/feed-bb158-4.png',
    lookbook1ReelUrl: 'https://www.instagram.com/reel/Dcn8NTSBZeB/',
    lookbook2ReelUrl: 'https://www.instagram.com/reel/DcX2wpcoi9x/',
    lookbook3ReelUrl: 'https://www.instagram.com/reel/DcLmwH3Isf-/',
    lookbook4ReelUrl: 'https://www.instagram.com/reel/DY4eExUuJm1/',
    editorialStackImage: '/editorial/sneaker-stack.jpg',
    newsletterBannerImage: '/newsletter-banner.jpg',
  },
...
// Cache TTLs — Multi-reload zero-egress protection
const CATALOG_CACHE_TTL_MS = 60 * 60 * 1000; // 60 minutes — zero egress across repeated reloads
const SETTINGS_CACHE_TTL_MS = 120 * 60 * 1000; // 120 minutes — zero egress across repeated reloads
