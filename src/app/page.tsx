...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full max-w-full overflow-x-hidden bg-[#FAFAF8] dark:bg-[#0A0A0A] text-brand-black dark:text-white transition-colors duration-300 select-none relative font-body">
