        ...
        <section className="py-16 bg-neutral-50 dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-800 transition-colors">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {displayedSkus.length === 0 ? (
              <div className="text-center py-12 bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-8">
                <p className="font-mono text-neutral-500 text-sm">
                  No footwear SKUs currently available in this category.
                </p>
              </div>
            ) : (
