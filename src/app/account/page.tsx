              ...
              <div className="p-6 rounded-none bg-neutral-50 dark:bg-neutral-950 border-2 border-neutral-900 dark:border-neutral-800 space-y-4 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                <div className="flex items-center gap-4">
                  {currentUser.photoURL ? (
                    <div className="relative w-14 h-14 shrink-0 rounded-none border-2 border-black dark:border-white overflow-hidden shadow-md bg-neutral-100 dark:bg-neutral-900">
                      <img
                      ...
                      />
                      <div className="absolute bottom-0 right-0 bg-white p-0.5 border-t border-l border-black shadow-xs">
                    ...
                    <div className="relative w-14 h-14 shrink-0 rounded-none bg-red-600 text-white flex items-center justify-center font-heading text-2xl font-black border-2 border-black dark:border-white shadow-md">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-heading text-xl font-black text-neutral-950 dark:text-white uppercase truncate">
                      {currentUser.displayName || 'BLISS BALANCE MEMBER'}
                    </h3>
                    <p className="font-mono text-xs text-red-600 font-black truncate">
                      {currentUser.email}
                    </p>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t-2 border-neutral-200 dark:border-neutral-800 grid grid-cols-2 gap-4 text-xs font-mono font-bold">
                  ...
                  <div>
                    <span className="block text-neutral-400 text-[10px] uppercase font-black">Order Fulfillment</span>
                    <span className="font-black text-neutral-900 dark:text-white flex items-center gap-1">
                      <Sparkles className="w-3.5 h-3.5 text-amber-500" /> Shipped by Amazon
                    </span>
                  </div>
                </div>
              </div>
