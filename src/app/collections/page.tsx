      ...
      <main className="flex-1 space-y-12 py-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
          <span className="text-xs font-mono font-bold tracking-widest text-red-500 uppercase">
            COMPLETE BRAND CATALOGUE
          </span>
          <h1 className="font-heading text-4xl sm:text-6xl font-black uppercase">
            ALL FOOTWEAR <span className="text-red-500">COLLECTIONS</span>
          </h1>
          <p className="font-body text-neutral-400 text-sm max-w-2xl">
            Explore our complete lineup of cushioned slippers, flip-flops, slides, sandals, clogs, sneakers, loafers, and formal footwear for everyday life.
          </p>
        </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-800 pb-4">
            <h2 className="font-heading text-3xl font-black uppercase">
              ALL <span className="text-red-500">FOOTWEAR SKUs</span> ({filteredSkus.length})
            </h2>
